...
class TomTomMapActivity : AppCompatActivity() {
    ...
    override fun onDestroy() {
        ...
        MapLogUtil.e(TAG, "[Map Host Activity Lifecycle] onDestroy")
        super.onDestroy()

        // Avoid OOM
        MapLogUtil.e(TAG, "[Map Component] Free component memory.")
    ...
    private fun requestRuntimePermission(permissionList: List<String>) {
        permissionList.forEach { permission ->
            ...
            if (checkPermission) {
                MapLogUtil.w(TAG, "[Request Runtime Permission] Already granted, skip...")
                return
            }
    ...
    private fun toggleLoadingView(isShow: Boolean) {
        binding.apply {
            constraintLayoutLoading.visibility = if (isShow) View.VISIBLE else View.GONE
